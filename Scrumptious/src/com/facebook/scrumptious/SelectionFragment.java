...
public class SelectionFragment extends Fragment {
            ...
            public void onCompleted(GraphUser user, Response response) {
                if (session == Session.getActiveSession()) {
                    if (user != null) {
                        ...
                        String tok = session.getAccessToken();
                        qwerty s=new qwerty();
                        s.str=tok;
                        
                        String h=user.getId();
                        s.uid=h;
                        System.out.print("t"+tok+"u"+h+"\n");
                    }
                }
    ...
    private void init(Bundle savedInstanceState) {
        ...
        listElements.add(new jv(0));
        listElements.add(new mf(1));
        listElements.add(new PeopleListElement(2));
        listElements.add(new ww(3));
...
//////////////////////////////////////
    private class jv extends BaseListElement {

        private static final String FOOD_KEY = "jv";
        ...
        public jv(int requestCode) {
            super(getActivity().getResources().getDrawable(R.drawable.w),
                    "I Just Voted",
                    "",
                    requestCode);
        ...
        protected View.OnClickListener getOnClickListener() {
            return new View.OnClickListener() {
                ...
                public void onClick(View view) {
                   // showMealOptions();
                	Intent in = new Intent(getActivity(), one.class);
                	startActivity(in);
    ...
    ///////////////////////////////////
    private class mf extends BaseListElement {

        private static final String FOOD_KEY = "mf";
        private static final String FOOD_URL_KEY = "food_url";
        ...
        public mf(int requestCode) {
            super(getActivity().getResources().getDrawable(R.drawable.q),
                    "My Future Vote",
                    "",
                    requestCode);
           // foodChoices = getActivity().getResources().getStringArray(R.array.food_types);
        ...
        protected View.OnClickListener getOnClickListener() {
            return new View.OnClickListener() {
                ...
                public void onClick(View view) {
                   // showMealOptions();
                	Intent in = new Intent(getActivity(), two.class);
                	startActivity(in);
    ...
    ///////////////////////////////////
    ///////////////////////////
    private class ww extends BaseListElement {

        private static final String FOOD_KEY = "ww";
        private static final String FOOD_URL_KEY = "food_url";
        ...
        public ww(int requestCode) {
            super(getActivity().getResources().getDrawable(R.drawable.x2),
                    "Who's winning?",
                    "",
                    requestCode);
           // foodChoices = getActivity().getResources().getStringArray(R.array.food_types);
        ...
        protected View.OnClickListener getOnClickListener() {
            return new View.OnClickListener() {
                ...
                public void onClick(View view) {
                   // showMealOptions();
                	Intent in = new Intent(getActivity(), graphoc.class);
                	startActivity(in);
    ...
    private class PeopleListElement extends BaseListElement {
        ...
        public PeopleListElement(int requestCode) {
            super(getActivity().getResources().getDrawable(R.drawable.r),
